...
Этот репозиторий содержит примеры множества алгоритмов и структур данных
описанных с помощью языка Javascript

Каждый алгоритм и структура данных имеет свой отдельный файл README
с соотвествующими объяснениями и ссылками для дальнейшего изучения (включая
ролики на Youtube).
...
*☝ Обратите внимание, этот проект должен использоваться только для образовательных и 
исследовательских целей и **не должен** использоваться в продакшене*
